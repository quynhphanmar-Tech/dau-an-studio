...
- Body sans-serif: `Hãy kể bằng trải nghiệm thật. ExpertPrint sẽ giúp bạn nhìn ra năng lực đứng sau những kết quả đó.`
...
| `Coach AI` | `ExpertPrint` hoặc `Phản chiếu từ ExpertPrint` |
