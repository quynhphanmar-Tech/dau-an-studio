# MASTER PROMPT - CODE EXPERTPRINT MVP

## 0. Vai trò và nguyên tắc thực thi

Bạn là một team gồm Product Architect, Senior UX Designer, Full-stack Engineer, AI Engineer, Security Engineer và QA Lead. Hãy xây dựng một web app tiếng Việt production-ready tên tạm thời **ExpertPrint** dành riêng cho CEO, Founder và chuyên gia 30+ có chuyên môn thật nhưng không giỏi marketing, branding và công nghệ.
...
> Bạn kể về công việc của mình. ExpertPrint giúp thị trường hiểu vì sao họ nên chọn bạn.
...
- Dùng high-contrast Didone gợi tinh thần editorial của Zara cho wordmark, tiêu đề lớn và câu hỏi quan trọng; không sao chép logo Zara.
- Toàn bộ UI/body dùng neo-grotesk sans-serif dễ đọc.
...
- Logo/motif: dấu vân tay liền, đơn giản, thoáng, không lồng chữ phức tạp và không giống ứng dụng bảo mật.
...
ElevenLabs có thể là provider cho voice clone/text-to-speech; HeyGen có thể là provider cho avatar và video. Đây là adapter hạ tầng, không phải bộ não nội dung. `Brand Memory`, `Thinking DNA`, `Writing DNA`, script approval và provenance luôn thuộc ExpertPrint, độc lập với vendor.
